...
export const Banner = () => {
  return (
    <div className="text-white aspect-[5/1] min-h-[248px] flex gap-x-6 p-6 items-center rounded-xl bg-gradient-to-r from-[#2e6ecb] via-[#0073ff] to-[#3faff5]">
      ...
      >
        <h1 className="text-xl md:text-3xl font-semibold">
          Visualize your ideas with AIdeate
        </h1>
